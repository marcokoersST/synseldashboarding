...
// Monteurs consultants (new)
const monteursConsultants: ConsultantWithTrends[] = [
  {
    id: 11, name: "Bas Kuijpers", role: "Senior Recruiter", revenue: 1540000,
  ...
  {
    id: 12, name: "Fleur Martens", role: "Recruiter", revenue: 1180000,
  ...
  {
    id: 13, name: "Wouter de Bruin", role: "Junior Recruiter", revenue: 890000,
  ...
  {
    id: 14, name: "Nadia Bosman", role: "Recruiter", revenue: 1320000,
