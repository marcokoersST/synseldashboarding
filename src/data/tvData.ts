...
export const weekUnitBreakdown: UnitFunnelRow[] = [
  { unit: "Engineering", color: "hsl(var(--primary))", toegewezen: 18, ingeschreven: 14, intakes: 10, acquisities: 5, voorstellenPerKandidaat: 2.1, voorstellenViaEmail: 6, voorstellenViaTelefoon: 4, uitnodigingenTotaal: 12, nietUitgenodigd: 4, welUitgenodigd: 8, eersteGesprek: 7, geenEersteGesprek: 3, welEersteGesprek: 4, vervolgGesprek: 3, dealsluiter: 2, geplaatst: 2, gemDagenTotPlaatsing: 28 },
  { unit: "Monteurs", color: "hsl(var(--chart-primary))", toegewezen: 10, ingeschreven: 8, intakes: 6, acquisities: 3, voorstellenPerKandidaat: 1.8, voorstellenViaEmail: 3, voorstellenViaTelefoon: 2, uitnodigingenTotaal: 6, nietUitgenodigd: 2, welUitgenodigd: 4, eersteGesprek: 3, geenEersteGesprek: 1, welEersteGesprek: 2, vervolgGesprek: 2, dealsluiter: 1, geplaatst: 1, gemDagenTotPlaatsing: 35 },
  { unit: "Operators", color: "hsl(var(--accent))", toegewezen: 15, ingeschreven: 12, intakes: 8, acquisities: 4, voorstellenPerKandidaat: 2.3, voorstellenViaEmail: 5, voorstellenViaTelefoon: 3, uitnodigingenTotaal: 9, nietUitgenodigd: 3, welUitgenodigd: 6, eersteGesprek: 5, geenEersteGesprek: 2, welEersteGesprek: 3, vervolgGesprek: 3, dealsluiter: 2, geplaatst: 2, gemDagenTotPlaatsing: 22 },
  { unit: "Trainingsunit", color: "hsl(var(--gold))", toegewezen: 7, ingeschreven: 5, intakes: 3, acquisities: 2, voorstellenPerKandidaat: 1.5, voorstellenViaEmail: 2, voorstellenViaTelefoon: 1, uitnodigingenTotaal: 4, nietUitgenodigd: 1, welUitgenodigd: 3, eersteGesprek: 2, geenEersteGesprek: 1, welEersteGesprek: 1, vervolgGesprek: 1, dealsluiter: 1, geplaatst: 1, gemDagenTotPlaatsing: 42 },
  { unit: "Early Performers", color: "hsl(var(--teal))", toegewezen: 4, ingeschreven: 3, intakes: 1, acquisities: 1, voorstellenPerKandidaat: 1.0, voorstellenViaEmail: 1, voorstellenViaTelefoon: 1, uitnodigingenTotaal: 2, nietUitgenodigd: 1, welUitgenodigd: 1, eersteGesprek: 1, geenEersteGesprek: 0, welEersteGesprek: 1, vervolgGesprek: 0, dealsluiter: 0, geplaatst: 0, gemDagenTotPlaatsing: 0 },
];
...
export const consultantFunnelData: Record<string, ConsultantFunnelRow[]> = {
  Engineering: [
    { unit: "Engineering", name: "Delano Nikkels", toegewezen: 7, ingeschreven: 6, intakes: 4, acquisities: 2, voorstellenPerKandidaat: 2.5, voorstellenViaEmail: 3, voorstellenViaTelefoon: 2, uitnodigingenTotaal: 5, nietUitgenodigd: 1, welUitgenodigd: 4, eersteGesprek: 3, geenEersteGesprek: 1, welEersteGesprek: 2, vervolgGesprek: 2, dealsluiter: 1, geplaatst: 1, gemDagenTotPlaatsing: 25 },
    { unit: "Engineering", name: "Falco Zegveld", toegewezen: 6, ingeschreven: 5, intakes: 4, acquisities: 2, voorstellenPerKandidaat: 1.8, voorstellenViaEmail: 2, voorstellenViaTelefoon: 1, uitnodigingenTotaal: 4, nietUitgenodigd: 2, welUitgenodigd: 2, eersteGesprek: 2, geenEersteGesprek: 1, welEersteGesprek: 1, vervolgGesprek: 1, dealsluiter: 1, geplaatst: 1, gemDagenTotPlaatsing: 30 },
    { unit: "Engineering", name: "Niels Florijn", toegewezen: 5, ingeschreven: 3, intakes: 2, acquisities: 1, voorstellenPerKandidaat: 2.0, voorstellenViaEmail: 1, voorstellenViaTelefoon: 1, uitnodigingenTotaal: 3, nietUitgenodigd: 1, welUitgenodigd: 2, eersteGesprek: 2, geenEersteGesprek: 1, welEersteGesprek: 1, vervolgGesprek: 0, dealsluiter: 0, geplaatst: 0, gemDagenTotPlaatsing: 0 },
  ],
  Monteurs: [
    { unit: "Monteurs", name: "Bart van Vliet", toegewezen: 5, ingeschreven: 4, intakes: 3, acquisities: 2, voorstellenPerKandidaat: 2.0, voorstellenViaEmail: 2, voorstellenViaTelefoon: 1, uitnodigingenTotaal: 3, nietUitgenodigd: 1, welUitgenodigd: 2, eersteGesprek: 2, geenEersteGesprek: 1, welEersteGesprek: 1, vervolgGesprek: 1, dealsluiter: 1, geplaatst: 1, gemDagenTotPlaatsing: 33 },
    { unit: "Monteurs", name: "Kaylee van den Berg", toegewezen: 5, ingeschreven: 4, intakes: 3, acquisities: 1, voorstellenPerKandidaat: 1.5, voorstellenViaEmail: 1, voorstellenViaTelefoon: 1, uitnodigingenTotaal: 3, nietUitgenodigd: 1, welUitgenodigd: 2, eersteGesprek: 1, geenEersteGesprek: 0, welEersteGesprek: 1, vervolgGesprek: 1, dealsluiter: 0, geplaatst: 0, gemDagenTotPlaatsing: 0 },
  ],
  Operators: [
    { unit: "Operators", name: "Christiaan van Krieken", toegewezen: 8, ingeschreven: 7, intakes: 5, acquisities: 2, voorstellenPerKandidaat: 2.5, voorstellenViaEmail: 3, voorstellenViaTelefoon: 2, uitnodigingenTotaal: 5, nietUitgenodigd: 1, welUitgenodigd: 4, eersteGesprek: 3, geenEersteGesprek: 1, welEersteGesprek: 2, vervolgGesprek: 2, dealsluiter: 1, geplaatst: 1, gemDagenTotPlaatsing: 20 },
    { unit: "Operators", name: "Mahesh Behari", toegewezen: 7, ingeschreven: 5, intakes: 3, acquisities: 2, voorstellenPerKandidaat: 2.0, voorstellenViaEmail: 2, voorstellenViaTelefoon: 1, uitnodigingenTotaal: 4, nietUitgenodigd: 2, welUitgenodigd: 2, eersteGesprek: 2, geenEersteGesprek: 1, welEersteGesprek: 1, vervolgGesprek: 1, dealsluiter: 1, geplaatst: 1, gemDagenTotPlaatsing: 24 },
  ],
  Trainingsunit: [
    { unit: "Trainingsunit", name: "Dees Beeking", toegewezen: 7, ingeschreven: 5, intakes: 3, acquisities: 2, voorstellenPerKandidaat: 1.5, voorstellenViaEmail: 2, voorstellenViaTelefoon: 1, uitnodigingenTotaal: 4, nietUitgenodigd: 1, welUitgenodigd: 3, eersteGesprek: 2, geenEersteGesprek: 1, welEersteGesprek: 1, vervolgGesprek: 1, dealsluiter: 1, geplaatst: 1, gemDagenTotPlaatsing: 40 },
  ],
  "Early Performers": [
    { unit: "Early Performers", name: "Ted Bronkhorst", toegewezen: 4, ingeschreven: 3, intakes: 1, acquisities: 1, voorstellenPerKandidaat: 1.0, voorstellenViaEmail: 1, voorstellenViaTelefoon: 1, uitnodigingenTotaal: 2, nietUitgenodigd: 1, welUitgenodigd: 1, eersteGesprek: 1, geenEersteGesprek: 0, welEersteGesprek: 1, vervolgGesprek: 0, dealsluiter: 0, geplaatst: 0, gemDagenTotPlaatsing: 0 },
  ],
};
...
export const periodUnitBreakdown: UnitFunnelRow[] = [
  { unit: "Engineering", color: "hsl(var(--primary))", toegewezen: 72, ingeschreven: 56, intakes: 40, acquisities: 20, voorstellenPerKandidaat: 2.2, voorstellenViaEmail: 24, voorstellenViaTelefoon: 14, uitnodigingenTotaal: 48, nietUitgenodigd: 16, welUitgenodigd: 32, eersteGesprek: 28, geenEersteGesprek: 12, welEersteGesprek: 16, vervolgGesprek: 12, dealsluiter: 8, geplaatst: 8, gemDagenTotPlaatsing: 27 },
  { unit: "Monteurs", color: "hsl(var(--chart-primary))", toegewezen: 40, ingeschreven: 32, intakes: 24, acquisities: 12, voorstellenPerKandidaat: 1.9, voorstellenViaEmail: 12, voorstellenViaTelefoon: 7, uitnodigingenTotaal: 24, nietUitgenodigd: 8, welUitgenodigd: 16, eersteGesprek: 12, geenEersteGesprek: 4, welEersteGesprek: 8, vervolgGesprek: 8, dealsluiter: 4, geplaatst: 4, gemDagenTotPlaatsing: 34 },
  { unit: "Operators", color: "hsl(var(--accent))", toegewezen: 60, ingeschreven: 48, intakes: 32, acquisities: 16, voorstellenPerKandidaat: 2.4, voorstellenViaEmail: 20, voorstellenViaTelefoon: 12, uitnodigingenTotaal: 36, nietUitgenodigd: 12, welUitgenodigd: 24, eersteGesprek: 20, geenEersteGesprek: 8, welEersteGesprek: 12, vervolgGesprek: 12, dealsluiter: 8, geplaatst: 8, gemDagenTotPlaatsing: 21 },
  { unit: "Trainingsunit", color: "hsl(var(--gold))", toegewezen: 28, ingeschreven: 20, intakes: 12, acquisities: 8, voorstellenPerKandidaat: 1.6, voorstellenViaEmail: 8, voorstellenViaTelefoon: 5, uitnodigingenTotaal: 16, nietUitgenodigd: 4, welUitgenodigd: 12, eersteGesprek: 8, geenEersteGesprek: 4, welEersteGesprek: 4, vervolgGesprek: 4, dealsluiter: 4, geplaatst: 4, gemDagenTotPlaatsing: 40 },
  { unit: "Early Performers", color: "hsl(var(--teal))", toegewezen: 16, ingeschreven: 12, intakes: 4, acquisities: 4, voorstellenPerKandidaat: 1.1, voorstellenViaEmail: 4, voorstellenViaTelefoon: 2, uitnodigingenTotaal: 8, nietUitgenodigd: 4, welUitgenodigd: 4, eersteGesprek: 4, geenEersteGesprek: 0, welEersteGesprek: 4, vervolgGesprek: 0, dealsluiter: 0, geplaatst: 0, gemDagenTotPlaatsing: 0 },
];
...
function buildConsultantRowsForUnit(unitRow: UnitFunnelRow, names: string[]): ConsultantFunnelRow[] {
  ...
  const numericKeys: (keyof Omit<UnitFunnelRow, "unit" | "color" | "subUnit" | "voorstellenPerKandidaat" | "gemDagenTotPlaatsing">)[] = [
    ...
    "voorstellenViaEmail", "voorstellenViaTelefoon", "uitnodigingenTotaal", "nietUitgenodigd", "welUitgenodigd",
  ...
  return names.map((name, idx) => {
    const row: ConsultantFunnelRow = {
      ...
      voorstellenViaTelefoon: distributed.voorstellenViaTelefoon[idx],
