        ...
        <CardContent className="p-0">
          <div className="max-h-[480px] overflow-auto">
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead className="sticky top-0 bg-background z-10">Platform / Segment</TableHead>
              ...
              <TableBody>
                {grouped.map((parent) => {
                  ...
                  return (
                    <>
                      <TableRow key={parent.platform} className="cursor-pointer hover:bg-muted/50" onClick={() => toggle(parent.platform)}>
                      ...
                      {isOpen && parent.children.map((child) => {
                        ...
                        return (
                          <TableRow key={`${parent.platform}-${child.segment}`} className="bg-muted/20">
                            <TableCell className="pl-10 text-muted-foreground">{child.segment}</TableCell>
