...
import { paidSocialData, aggregateByUnit, aggregateByFunctiegroep, totals as calcTotals, formatCurrency, deltaPercent, MARKETING_COLORS } from "@/data/marketingHubData";
...
const PaidSocialTab = ({ dateRange, compareRange, deltaMode = "percent" }: Props) => {
  ...
  const fgChart = useMemo(() => aggregateByFunctiegroep(paidSocialData), []);
