    ...
    <TVDashboardLayout title="Funnel Operations · Overzicht">
      <div className="flex flex-col h-full gap-2">
        ...
        <div className="flex-1 min-h-0 rounded-lg border border-border bg-card overflow-hidden flex flex-col shadow-sm">
          <div className="flex items-center justify-between gap-4 px-3 py-2 border-b border-border bg-muted/30">
            <div className="flex items-center gap-2">
              <AlertTriangle className="w-4 h-4 text-destructive" />
              <span className="text-sm font-semibold">Acties vandaag</span>
              <span className="text-xs text-muted-foreground">
                {rows.length} open · <span className="text-destructive font-medium">{verlopen} verlopen</span>{" "}
          ...
          <div className="grid grid-cols-12 items-center gap-2 px-3 py-1.5 text-[10px] uppercase tracking-wider text-muted-foreground bg-muted/20 border-b border-border font-semibold">
